...
my %options=();
getopts('i:o:b', \%options);

my $usage = "## USAGE: sgr_builder.pl [REQUIRED] -i infile.txt -o outfile.sgr -b {bin width}";
...
open(IN, $infile) or die "Unable to access input file: $indir $!\n";
