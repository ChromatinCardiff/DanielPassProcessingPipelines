...
def main():
    ...
    regionDict = regionExtract(samfile,chrom, regionStart, regionEnd)

    samfile.close()

    surfaceMat = makeSurfaceArray(regionDict)

    #testMat = [[1, 2, 3, 4, 9],[4, 1, 3, 7, 9],[5, 4, 7, 2, 9]]

    #print testMat
    #print type(testMat)
    surfaceMatrix = surfaceMat
    #print surfaceMatrix
    #print type(surfaceMatrix)

    make3dPlot(surfaceMatrix, regionStart, regionEnd)
