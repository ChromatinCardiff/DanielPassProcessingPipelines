...
if __name__ =='__main__':
    ...
    parser.add_argument('-w', default=21, help='Window length of the probes you want to test | default = 20')
    parser.add_argument('-r', help='Reference fasta file that you want to test against (FASTA FORMAT)')
    ...
    if args.i:
        with open(args.i, "rU") as handle:
            for siRNA in SeqIO.parse(handle, "fasta"):
                ...
                probesFile =  str(args.i) + ".probes.fasta"
...
def sliceProbe(siRNA):
    print "Reading siRNA and sliceing it into windows of", args.w, "size"
