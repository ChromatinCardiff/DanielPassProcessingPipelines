...
workDir <- "~/Projects/AGM/RNAseq/"      # working directory for the R session

projectName <- "AGM-EdgeR"                         # name of the project
author <- "Daniel Pass"                                # author of the statistical analysis/report

targetFile <- "sartoolsmap.txt"                           # path to the design/target file
rawDir <- "HTSeq"                                      # path to the directory containing raw counts files
featuresToRemove <- c("alignment_not_unique",        # names of the features to be removed
                      "ambiguous", "no_feature",     # (specific HTSeq-count information and rRNA for example)
                      "not_aligned", "too_low_aQual")# NULL if no feature to remove

varInt <- "Description"                                    # factor of interest
condRef <- "Col0WT"                                      # reference biological condition
