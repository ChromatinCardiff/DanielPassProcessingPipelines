...
# Read in
TSS <- read.table("/home/sbi6dap/Projects/AGM/MNaseseq/danposProfileFull/mean_full_TSS.xls", header=TRUE, sep="\t")
TTS <- read.table("/home/sbi6dap/Projects/AGM/MNaseseq/danposProfileFull/mean_full_TTS.xls", header=TRUE, sep="\t")
CSS <- read.table("/home/sbi6dap/Projects/AGM/MNaseseq/danposProfileFull/mean_full_CSS.xls", header=TRUE, sep="\t")
CTS <- read.table("/home/sbi6dap/Projects/AGM/MNaseseq/danposProfileFull/mean_full_CTS.xls", header=TRUE, sep="\t")
ESS <- read.table("/home/sbi6dap/Projects/AGM/MNaseseq/danposProfileFull/mean_full_ESS.xls", header=TRUE, sep="\t")
ETS <- read.table("/home/sbi6dap/Projects/AGM/MNaseseq/danposProfileFull/mean_full_ETS.xls", header=TRUE, sep="\t")
gene <- read.table("/home/sbi6dap/Projects/AGM/MNaseseq/danposProfileFull/mean_full_gene.xls", header=TRUE, sep="\t")
